...
public interface PlayerRepository extends JpaRepository<Player, Integer> {
    ...
    @Query("select new com.example.data_service.dto.PlayerDto(p.id, p.nickname) from Player p where p.id in :ids")
    java.util.List<PlayerDto> findAllDtoByIdIn(@Param("ids") java.util.List<Integer> ids);
}