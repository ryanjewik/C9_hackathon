...
import { uploadVod, getJobStatus, downloadFile, JobResponse } from '../api';
          ...
          {job.status === 'COMPLETED' && (
            <div className="mt-3 flex gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white/80 hover:bg-white border border-c9-cyan/40 hover:border-c9-cyan text-c9-text rounded-xl transition-colors text-sm"
              >
